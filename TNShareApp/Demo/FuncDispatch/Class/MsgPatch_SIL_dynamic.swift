...
// animal
sil_global hidden [let] @$s20MsgPatch_SIL_dynamic6animalAA6AnimalCvp : $Animal

// main
sil @main : $@convention(c) (Int32, UnsafeMutablePointer<Optional<UnsafeMutablePointer<Int8>>>) -> Int32 {
bb0(%0 : $Int32, %1 : $UnsafeMutablePointer<Optional<UnsafeMutablePointer<Int8>>>):
  alloc_global @$s20MsgPatch_SIL_dynamic6animalAA6AnimalCvp // id: %2
  %3 = global_addr @$s20MsgPatch_SIL_dynamic6animalAA6AnimalCvp : $*Animal // users: %8, %7
  %4 = metatype $@thick Animal.Type               // user: %6
  // function_ref Animal.__allocating_init()
  %5 = function_ref @$s20MsgPatch_SIL_dynamic6AnimalCACycfC : $@convention(method) (@thick Animal.Type) -> @owned Animal // user: %6
...
// Animal.makeSound()
sil hidden @$s20MsgPatch_SIL_dynamic6AnimalC9makeSoundyyF : $@convention(method) (@guaranteed Animal) -> () {
// %0 "self"                                      // user: %1
bb0(%0 : $Animal):
  ...
  %27 = tuple ()                                  // user: %28
  return %27 : $()                                // id: %28
} // end sil function '$s20MsgPatch_SIL_dynamic6AnimalC9makeSoundyyF'
...
sil private [thunk] @$s20MsgPatch_SIL_dynamic6AnimalC9makeSoundyyFTo : $@convention(objc_method) (Animal) -> () {
// %0                                             // users: %4, %3, %1
bb0(%0 : $Animal):
  strong_retain %0 : $Animal                      // id: %1
  // function_ref Animal.makeSound()
  %2 = function_ref @$s20MsgPatch_SIL_dynamic6AnimalC9makeSoundyyF : $@convention(method) (@guaranteed Animal) -> () // user: %3
  %3 = apply %2(%0) : $@convention(method) (@guaranteed Animal) -> () // user: %5
  strong_release %0 : $Animal                     // id: %4
  return %3 : $()                                 // id: %5
} // end sil function '$s20MsgPatch_SIL_dynamic6AnimalC9makeSoundyyFTo'

// Animal.makeSleep()
sil hidden [dynamically_replacable] @$s20MsgPatch_SIL_dynamic6AnimalC9makeSleepyyF : $@convention(method) (@guaranteed Animal) -> () {
// %0 "self"                                      // user: %1
bb0(%0 : $Animal):
  debug_value %0 : $Animal, let, name "self", argno 1, implicit // id: %1
  %2 = integer_literal $Builtin.Word, 1           // user: %4
  ...
  %27 = tuple ()                                  // user: %28
  return %27 : $()                                // id: %28
} // end sil function '$s20MsgPatch_SIL_dynamic6AnimalC9makeSleepyyF'

// Animal.__allocating_init()
sil hidden @$s20MsgPatch_SIL_dynamic6AnimalCACycfC : $@convention(method) (@thick Animal.Type) -> @owned Animal {
// %0 "$metatype"                                 // user: %1
...
} // end sil function '$s20MsgPatch_SIL_dynamic6AnimalCACycfC'

// dynamic Animal.init()
sil shared [transparent] [thunk] @$s20MsgPatch_SIL_dynamic6AnimalCACycfcTD : $@convention(method) (@owned Animal) -> @owned Animal {
// %0 "self"                                      // users: %2, %1
bb0(%0 : $Animal):
...
} // end sil function '$s20MsgPatch_SIL_dynamic6AnimalCACycfcTD'

// Animal.init()
sil hidden @$s20MsgPatch_SIL_dynamic6AnimalCACycfc : $@convention(method) (@owned Animal) -> @owned Animal {
// %0 "self"                                      // user: %2
bb0(%0 : $Animal):
...
// @objc Animal.init()
sil private [thunk] @$s20MsgPatch_SIL_dynamic6AnimalCACycfcTo : $@convention(objc_method) (@owned Animal) -> @owned Animal {
// %0                                             // user: %2
bb0(%0 : $Animal):
  // function_ref Animal.init()
  %1 = function_ref @$s20MsgPatch_SIL_dynamic6AnimalCACycfc : $@convention(method) (@owned Animal) -> @owned Animal // user: %2
  %2 = apply %1(%0) : $@convention(method) (@owned Animal) -> @owned Animal // user: %3
  return %2 : $Animal                             // id: %3
} // end sil function '$s20MsgPatch_SIL_dynamic6AnimalCACycfcTo'

// Animal.__deallocating_deinit
sil hidden @$s20MsgPatch_SIL_dynamic6AnimalCfD : $@convention(method) (@owned Animal) -> () {
// %0 "self"                                      // users: %3, %2, %1
bb0(%0 : $Animal):
  debug_value %0 : $Animal, let, name "self", argno 1, implicit // id: %1
  ...
  %5 = tuple ()                                   // user: %6
  return %5 : $()                                 // id: %6
} // end sil function '$s20MsgPatch_SIL_dynamic6AnimalCfD'
...
sil_vtable Animal {
  #Animal.makeSound: (Animal) -> () -> () : @$s20MsgPatch_SIL_dynamic6AnimalC9makeSoundyyF	// Animal.makeSound()
  #Animal.makeSleep: (Animal) -> () -> () : @$s20MsgPatch_SIL_dynamic6AnimalC9makeSleepyyF	// Animal.makeSleep()
  #Animal.deinit!deallocator: @$s20MsgPatch_SIL_dynamic6AnimalCfD	// Animal.__deallocating_deinit
}



// Mappings from '#fileID' to '#filePath':
//   'MsgPatch_SIL_dynamic/MsgPatch.swift' => 'MsgPatch.swift'
